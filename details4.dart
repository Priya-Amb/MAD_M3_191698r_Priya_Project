...
class DetailsPage4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
    appBar: AppBar(title: Text('Appointment', style: TextStyle(color: Colors.black87),
    ),
  ...
  Image _bigImage(){
    return Image(image: AssetImage('images/anikolleshi.jpg'),
    fit: BoxFit.cover,
    );
  }
  Column _nameInfo(){
